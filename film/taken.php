   ...
   session_start();
    if(!isset($_SESSION['permesso'])){
	 ...
	 $videoteca = simplexml_load_file("../videoteca.xml") or die ("Errore!");	
	 	echo "<br /><h1 style='text-align:center'>",$videoteca->film[6]->titolo."</h1>";
		$url = $videoteca->film[6]->trailer;		
?>
      <br />
      <p class="locandina"><img src="<?php echo $videoteca->film[6]->copertina; ?>"/></p>
	  <div style="margin-left:29.6%;">
	  <br /> 
		 <?php
		        echo "<p>ISAN : ", $videoteca->film[6]->attributes()->ISAN . "<br> </p>";
				echo "<p>Anno : ", $videoteca->film[6]->anno . "<br> </p>";
			    echo "<p>Durata : ", $videoteca->film[6]->durata . "&nbsp;minuti<br></p>";
				echo "<p>Genere : ", $videoteca->film[6]->genere . "<br></p>";
				echo "<p>Regista : ", $videoteca->film[6]->regista->nome_regista . "&nbsp;" .$videoteca->film[6]->regista->cognome_regista . "<br></p>";		   	
			    echo "<span>Cast : </span>";
				foreach($videoteca->film[6] as $cast){
		...
		<div class="trama" style="width:600px;margin-left:auto;margin-right:auto;display:block;">
		 <p style="text-align:center;"><?php echo $videoteca->film[6]->trama ?></p>
		 </div>
		<br />
		<br />
		<h2 style="text-align:center;">Trailer</h2>
		<p style="text-align:center;"><embed src="<?php echo $url; ?>" width="650" height="400" title="Taken - trailer"></p>
	</body>
</html>
