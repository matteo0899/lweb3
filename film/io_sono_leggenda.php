   ...
   session_start();
    if(!isset($_SESSION['permesso'])){
	 ...
	 $videoteca = simplexml_load_file("../videoteca.xml") or die ("Errore!");	
	 	echo "<br /><h1 style='text-align:center'>",$videoteca->film[1]->titolo."</h1>";	
		$url = $videoteca->film[1]->trailer;	
?>
      <br />
      <p class="locandina"><img src="../img/copertine/io_sono_leggenda_2.jpg" /></p>
	  <div style="margin-left:29.6%;">
	  <br /> 
		 <?php
		        echo "<p>ISAN : ", $videoteca->film[1]->attributes()->ISAN . "<br> </p>";
				echo "<p>Anno : ", $videoteca->film[1]->anno . "<br> </p>";
			    echo "<p>Durata : ", $videoteca->film[1]->durata . "&nbsp;minuti<br></p>";
				echo "<p>Genere : ", $videoteca->film[1]->genere . "<br></p>";
				echo "<p>Regista : ", $videoteca->film[1]->regista->nome_regista . "&nbsp;" .$videoteca->film[1]->regista->cognome_regista . "<br></p>";		   	
			    echo "<span>Cast : </span>";
				foreach($videoteca->film[1] as $cast){
		...
		<div class="trama" style="width:600px;margin-left:auto;margin-right:auto;display:block;">
		 <p style="text-align:center;"><?php echo $videoteca->film[1]->trama ?></p>
		 </div>
		<br />
		<br />
		<h2 style="text-align:center;">Trailer</h2>
		 <p style="text-align:center;"><embed src="<?php echo $url; ?>" width="650" height="400" title="Io sono Leggenda - trailer"></p>
	</body>
</html>