   ...
   session_start();
    if(!isset($_SESSION['permesso'])){
	 ...
	 $videoteca = simplexml_load_file("../videoteca.xml") or die ("Errore!");	
	 	echo "<br /><h1 style='text-align:center'>",$videoteca->film[3]->titolo."</h1>";		
		$url = $videoteca->film[3]->trailer;
?>
      <br />
      <p class="locandina"><img src="<?php echo $videoteca->film[3]->copertina ?>" /></p>
	  <div style="margin-left:29.6%;">
	  <br /> 
		 <?php
		        echo "<p>ISAN : ", $videoteca->film[3]->attributes()->ISAN . "<br> </p>";
				echo "<p>Anno : ", $videoteca->film[3]->anno . "<br> </p>";
			    echo "<p>Durata : ", $videoteca->film[3]->durata . "&nbsp;minuti<br></p>";
				echo "<p>Genere : ", $videoteca->film[3]->genere . "<br></p>";
				echo "<p>Regista : ", $videoteca->film[3]->regista->nome_regista . "&nbsp;" .$videoteca->film[3]->regista->cognome_regista . "<br></p>";		   	
			    echo "<span>Cast : </span>";
				foreach($videoteca->film[3] as $cast){
		...
		<div class="trama" style="width:600px;margin-left:auto;margin-right:auto;display:block;">
		 <p style="text-align:center;"><?php echo $videoteca->film[3]->trama ?></p>
		 </div>
		<br />
		<br />
